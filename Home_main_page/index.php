                ...
                <ul>
                  ...
                  <li>
                    ...
                    <div class="icon_more">
                      ...
                      <div id="moreDropdown" class="dropdown_more_content">
                        <a target="content" href="../edit_menu/frames/Them_san_pham/them_san_pham.html"><i class="fas fa-plus-square"></i></i>Thêm sản phẩm</a>

                        <a target="content" href="../edit_menu/frames/Thong_tin_san_pham/.html"><i class="fas fa-list"></i>Danh sách sản phẩm</a>
                  ...
                  <li>
                    <div class="dropdown">
                      ...
                      <div id="myDropdown" class="dropdown-content">
                        ...
                        <a target="content" href="../main-page/"
                          ><i class="fas fa-user"></i>Hồ sơ cá nhân</a
                        >
        ...
        <div class="body_container">
          <div class="frame_menu" >
            <div class="content-menu">
              ...
              <ul class="menu"><h3><i class="fas fa-clipboard">&nbsp;&nbsp;</i>Đơn Hàng</h3>
                  <li>
                      <ul class="sub-menu">
              ...
              <ul class="menu"><h3><i class="fas fa-tools">&nbsp;&nbsp;</i>Cấu hình</h3>
                  <li>
                      <ul class="sub-menu">
