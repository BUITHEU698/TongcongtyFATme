...
$account=$tach_ten[1].' '.$tach_ten[2]; } if (isset($_POST['mua1'])){ $TENMONAN='Xôi Xá Xíu';
$GIA='35000'; $THELOAI='Xôi'; $IMAGE='xoixaxiu.jpeg'; $SOLUONG=$_POST['SL1']; $sql="INSERT INTO
giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim1'])){ $TENMONAN='Xôi Xá Xíu'; $GIA='35000';
$THELOAI='Xôi'; $IMAGE='xoixaxiu.jpeg'; $sql="SELECT *FROM yeuthich WHERE
email_khachhang='$email'AND TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql);
$check=mysqli_num_rows($query); if ($check==0){ $sql="INSERT INTO
yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } if (isset($_POST['mua2'])){ $TENMONAN='Pizza Hải Sản Sốt Tiêu
Đen'; $GIA='69000'; $THELOAI='Pizza'; $IMAGE='pizza.jpeg'; $SOLUONG=$_POST['SL2']; $sql="INSERT INTO
giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim2'])){ $TENMONAN='Pizza Hải Sản Sốt Tiêu
Đen'; $GIA='69000'; $THELOAI='Pizza'; $IMAGE='pizza.jpeg'; $sql="SELECT *FROM yeuthich WHERE
email_khachhang='$email'AND TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql);
$check=mysqli_num_rows($query); if ($check==0){ $sql="INSERT INTO
yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } if (isset($_POST['mua3'])){ $TENMONAN='Jollibee - 02 miếng gà giòn
vui vẻ + 01 ly pepsi thường + tặng 1 lon pepsi blackpink'; $GIA='139000'; $THELOAI='Thức ăn nhanh';
$IMAGE='gavuive.jpeg'; $SOLUONG=$_POST['SL3']; $sql="INSERT INTO
giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim3'])){ $TENMONAN='Jollibee - 02 miếng gà
giòn vui vẻ + 01 ly pepsi thường + tặng 1 lon pepsi blackpink'; $GIA='139000'; $THELOAI='Thức ăn
nhanh'; $IMAGE='gavuive.jpeg'; $sql="SELECT *FROM yeuthich WHERE email_khachhang='$email'AND
TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql); $check=mysqli_num_rows($query); if
($check==0){ $sql="INSERT INTO yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } if (isset($_POST['mua4'])){ $TENMONAN='Combo Lộc Phúc';
$GIA='86000'; $THELOAI='Thức ăn nhanh'; $IMAGE='phucloc.png'; $SOLUONG=$_POST['SL4']; $sql="INSERT
INTO giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim4'])){ $TENMONAN='Combo Lộc Phúc';
$GIA='86000'; $THELOAI='Thức ăn nhanh'; $IMAGE='phucloc.png'; $sql="SELECT *FROM yeuthich WHERE
email_khachhang='$email'AND TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql);
$check=mysqli_num_rows($query); if ($check==0){ $sql="INSERT INTO
yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } if (isset($_POST['mua5'])){ $TENMONAN='1 Burger bò Teriyaki trứng
+ 1 Mì Ý + 1 Khoai Tây Chiên + 1 Pepsi'; $GIA='79000'; $THELOAI='Thức ăn nhanh';
$IMAGE='burger.png'; $SOLUONG=$_POST['SL4']; $sql="INSERT INTO
giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim5'])){ $TENMONAN='1 Burger bò Teriyaki trứng
+ 1 Mì Ý + 1 Khoai Tây Chiên + 1 Pepsi'; $GIA='79000'; $THELOAI='Thức ăn nhanh';
$IMAGE='burger.png'; $sql="SELECT *FROM yeuthich WHERE email_khachhang='$email'AND
TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql); $check=mysqli_num_rows($query); if
($check==0){ $sql="INSERT INTO yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } if (isset($_POST['mua6'])){ $TENMONAN='1 Gà Sốt Trứng Muối + 1
Pepsi'; $GIA='36000'; $THELOAI='Thức ăn nhanh'; $IMAGE='gatrungmuoi.png'; $SOLUONG=$_POST['SL6'];
$sql="INSERT INTO giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim6'])){ $TENMONAN='1 Gà Sốt Trứng Muối + 1
Pepsi'; $GIA='36000'; $THELOAI='Thức ăn nhanh'; $IMAGE='gatrungmuoi.png'; $sql="SELECT *FROM
yeuthich WHERE email_khachhang='$email'AND TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql);
$check=mysqli_num_rows($query); if ($check==0){ $sql="INSERT INTO
yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } if (isset($_POST['mua7'])){ $TENMONAN='Sữa chua Tocotoco';
$GIA='20000'; $THELOAI='Đồ uống'; $IMAGE='trasuatoco.jpeg'; $SOLUONG=$_POST['SL7']; $sql="INSERT
INTO giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim7'])){ $TENMONAN='Sữa chua Tocotoco';
$GIA='20000'; $THELOAI='Đồ uống'; $IMAGE='trasuatoco.jpeg'; $sql="SELECT *FROM yeuthich WHERE
email_khachhang='$email'AND TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql);
$check=mysqli_num_rows($query); if ($check==0){ $sql="INSERT INTO
yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } if (isset($_POST['mua8'])){ $TENMONAN='Beefsteak Bò Sốt Tiêu';
$GIA='70000'; $THELOAI='Beefsteak'; $IMAGE='beefsteak.jpeg'; $SOLUONG=$_POST['SL8']; $sql="INSERT
INTO giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim8'])){ $TENMONAN='Beefsteak Bò Sốt Tiêu';
$GIA='70000'; $THELOAI='Beefsteak'; $IMAGE='beefsteak.jpeg'; $sql="SELECT *FROM yeuthich WHERE
email_khachhang='$email'AND TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql);
$check=mysqli_num_rows($query); if ($check==0){ $sql="INSERT INTO
yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } if (isset($_POST['mua9'])){ $TENMONAN='Bánh Bạch Tuộc';
$GIA='99000'; $THELOAI='Ăn vặt'; $IMAGE='banhbachtuoc.jpeg'; $SOLUONG=$_POST['SL9']; $sql="INSERT
INTO giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim9'])){ $TENMONAN='Bánh Bạch Tuộc';
$GIA='99000'; $THELOAI='Ăn vặt'; $IMAGE='banhbachtuoc.jpeg'; $sql="SELECT *FROM yeuthich WHERE
email_khachhang='$email'AND TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql);
$check=mysqli_num_rows($query); if ($check==0){ $sql="INSERT INTO
yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } if (isset($_POST['mua10'])){ $TENMONAN='Gà Lá Chanh Tóp Mỡ Ngũ
Vị'; $GIA='105000'; $THELOAI='Đồ ăn mặn'; $IMAGE='galachanh.jpeg'; $SOLUONG=$_POST['SL10'];
$sql="INSERT INTO giohang(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI,SOLUONG)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI','$SOLUONG');";
$query=mysqli_query($conn,$sql); } if (isset($_POST['tim10'])){ $TENMONAN='Gà Lá Chanh Tóp Mỡ Ngũ
Vị'; $GIA='105000'; $THELOAI='Đồ ăn mặn'; $IMAGE='galachanh.jpeg'; $sql="SELECT *FROM yeuthich WHERE
email_khachhang='$email'AND TENMONAN='$TENMONAN'"; $query=mysqli_query($conn,$sql);
$check=mysqli_num_rows($query); if ($check==0){ $sql="INSERT INTO
yeuthich(email_khachhang,IMAGE,TENMONAN,GIA,THELOAI)
VALUES('$email','$IMAGE','$TENMONAN','$GIA','$THELOAI');"; $query=mysqli_query($conn,$sql); }else {
header("location:index.php"); } } $dsgiohang=mysqli_query($conn,"SELECT * FROM giohang WHERE
email_khachhang='$email'"); $dsyeuthich=mysqli_query($conn,"SELECT * FROM yeuthich WHERE
        ...
        <header class="header">
          <div class="navigation">
            ...
            <ul class="menu">
              ...
              <li class="menu-item">
                <a class="menu-link link-active" href="../mon-an/index.php">Món ăn</a>
              </li>
                ...
                foreach($dsgiohang as $key=>$value) { ?>
                    <li class="dropdown-item auth-shoppingcart-dropdown-item">
                      ...
                      <div class="dropdown-item-text">
                        ...
                        <div class="dropdown-item-text-price">
                          <span class="price"><?php echo formatMoney($value['GIA'])?></span>đ
                        </div>
                      </div>
                      <div class="dropdown-item-right">
                  ...
                  $tongtien=0;
                    ...
                    <li class="auth-shoppingcart-dropdown-item">
                      <?php if ($tongtien==0){ ?>
                      <span class="shoppingcart-alert"> Giỏ hàng của bạn đang trống ! </span>
                      <?php } else {?>
                      <a class="auth-shoppingcart-dropdown-link" href="../shoppingcart/index.php">
                        <span class="sum">
                          Tổng tiền:
                          <span class="sum-price"><?php echo formatMoney($tongtien) ?></span>đ
                        </span>
              ...
              <div class="banner-list">
                <div class="banner-item">
                  <div class="banner-header">
                    <span
                      class="banner-caption green global-heading global-heading--normal show-on-scroll"
                    ...
                    <p class="banner-desc global-text show-on-scroll">
                      Hướng đến việc tiện lợi khi ở nhà mà cũng có đồ ăn mọi lúc mọi nơi, chúng tôi
                      sẽ là người giúp các bạn thực hiện việc đó dễ dàng hơn.
                    </p>
                ...
                <div class="banner-product-list slider-responsive-banner-list">
                  <div class="banner-product-list-item">
                    <div class="banner-product-item orange-bg">
                      <div class="banner-product-header">
                        <div
                          class="banner-product-sale green global-heading global-heading--normal show-on-scroll"
                        >
                          Giảm giá 30%
                        </div>
                        <div
                          class="banner-product-title global-heading global-heading--normal show-on-scroll"
                        >
                          Grab food
                        </div>
                        <a
                          class="button button--green"
                          href="https://food.grab.com/vn/vi/"
                          target="_blank"
                          >Xem ngay</a
                        >
                      </div>
                  ...
                  <div class="banner-product-list-item">
                    <div class="banner-product-item green-bg">
                      <div class="banner-product-header">
                        <div
                          class="banner-product-sale red global-heading global-heading--normal show-on-scroll"
                        >
                          Giảm giá 50%
                        </div>
                        <div
                        ...
                        <a class="button button--red" href="https://loship.vn/" target="_blank"
                          >Xem ngay</a
                        >
                      </div>
                      <div class="banner-product-image">
                  ...
                  <div class="banner-product-list-item">
                    <div class="banner-product-item blue-dark-bg">
                      <div class="banner-product-header">
                        <div
                          class="banner-product-sale blue-dark global-heading global-heading--normal show-on-scroll"
                        >
                          Giảm giá 10%
                        </div>
                        <div
                  ...
                  <div class="banner-product-list-item">
                    <div class="banner-product-item green-bg">
                      <div class="banner-product-header">
                        <div
                          class="banner-product-sale orange global-heading global-heading--normal show-on-scroll"
                        >
                          Giảm giá 70%
                        </div>
                        <div
          ...
          <section class="category" id="category">
            <div class="food-container">
              <div class="food-header">
                <h2
                  class="food-heading global-heading global-food-heading show-on-scroll is-visible"
                >
                  Thể loại
                </h2>
                <div class="food-more">
                  ...
                  <a href="#!">
                    <div class="category-item">
                      ...
                      <div class="category-item-header">
                        ...
                        <div
                          class="category-item-title global-heading global-heading--normal show-on-scroll"
                        >
                          rau củ sạch
                        </div>
                      </div>
                  ...
                  <a href="./monan1/index.php">
                    <div class="product-item" id="gaga">
                      <div class="product-item-top">
                        ...
                        <button class="button-heart" name="tim1">
                          <img
                            src="../assets/images/main-images/icon-heart.png"
                            alt=""
                            class="heart"
                      ...
                      <div class="product-item-name">
                        ...
                        <div
                          class="product-item-title global-heading global-heading--normal show-on-scroll"
                        >
                          Khai Vị Tam Hợp
                        </div>
                      </div>
                ...
                <div class="product-list-item">
                  <a href="./monan2/index.php">
                    <div class="product-item">
                      <div class="product-item-top">
                        <div class="product-item-sale green-bgfull">Mới có</div>
                        <button class="button-heart" name="tim2">
                          <img
                            src="../assets/images/main-images/icon-heart.png"
                            alt=""
                            class="heart"
                  ...
                  <a href="./monan1/index.php">
                    <div class="product-item">
                      <div class="product-item-top">
                        ...
                        <button class="button-heart" name="tim3">
                          <img
                            src="../assets/images/main-images/icon-heart.png"
                            alt=""
                            class="heart"
                      ...
                      <div class="product-item-image">
                        <img
                          style="height: 200px"
                          src="../assets/images/food/gavuive.jpeg"
                          alt=""
                        />
                      </div>
                      <div class="product-item-name">
                      ...
                      <div class="product-item-bottom">
                        ...
                        <button class="button-shoppingcart" name="mua3">
                          <img
                            class="product-item-shoppingcart"
                            src="../assets/images/main-images/icon-shoppingcart.png"
                            alt=""
                ...
                <div class="product-list-item">
                  <a href="./monan1/index.php">
                    <div class="product-item">
                      <div class="product-item-top">
                        <div class="product-item-sale">Giảm giá khi mua combo</div>
                        <button class="button-heart" name="tim4">
                          <img
                            src="../assets/images/main-images/icon-heart.png"
                            alt=""
                            class="heart"
                ...
                <div class="product-list-item">
                  <a href="./monan1/index.php">
                    <div class="product-item">
                      <div class="product-item-top">
                        <div class="product-item-sale">Giảm giá khi mua combo</div>
                        <button class="button-heart" name="tim5">
                          <img
                            src="../assets/images/main-images/icon-heart.png"
                            alt=""
                            class="heart"
                ...
                <div class="product-list-item">
                  <a href="./monan1/index.php">
                    <div class="product-item">
                      <div class="product-item-top">
                        <div class="product-item-sale">Giảm giá khi mua combo</div>
                        <button class="button-heart" name="tim6">
                          <img
                            src="../assets/images/main-images/icon-heart.png"
                            alt=""
                            class="heart"
                  ...
                  <a href="./monan1/index.php">
                    <div class="product-item">
                      <div class="product-item-top">
                        ...
                        <button class="button-heart" name="tim7">
                          <img
                            src="../assets/images/main-images/icon-heart.png"
                            alt=""
                            class="heart"
              ...
              <div class="product-list slider-responsive-product-list">
                <div class="product-list-item">
                  <div class="product-item">
                    <div class="product-item-top">
                      ...
                      <button class="button-heart" name="tim8">
                        <img
                          src="../assets/images/main-images/icon-heart.png"
                          alt=""
                          class="heart"
                ...
                <div class="product-list-item">
                  <div class="product-item">
                    <div class="product-item-top">
                      <div class="product-item-sale green-bgfull">Đang hot</div>
                      <button class="button-heart" name="tim9">
                        <img
                          src="../assets/images/main-images/icon-heart.png"
                          alt=""
                          class="heart"
                ...
                <div class="product-list-item">
                  <div class="product-item">
                    <div class="product-item-top">
                      ...
                      <button class="button-heart" name="tim10">
                        <img
                          src="../assets/images/main-images/icon-heart.png"
                          alt=""
                          class="heart"
        ...
        <div class="container">
          <div class="footer-container">
            <div class="footer-column">
              ...
              <div class="social">
                <a
                  href="https://www.facebook.com/FootAtTheMoment/"
                  target="_blank"
                  class="social-item"
                >
