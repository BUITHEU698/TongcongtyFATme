        ...
        <div class="container">
            <form action="" method="post" class="form-login">
                ...
                <div class="form-group">
                    <input type="email" name="email" placeholder="Nhập email" class="input-text" autocomplete="e-mail" /><br />
                    <div class="relative">
                        <input type="password" name="password" placeholder="Nhập mật khẩu" id="passwd" class="input-text" />
